          ...
          return (
            <div key={index} className='tags-group-icon-pair ml-6 select-none'>
              <div
                ...
                className={
                  'tags-group-icon w-15 h-15 rounded-3xl flex items-center justify-center text-white text-lg font-bold shadow-md'
                }>
                <LazyImage
                  priority={true}
                  src={g.img_1}
              ...
              <div
                ...
                className={
                  'tags-group-icon  mt-5 w-15 h-15 rounded-3xl flex items-center justify-center text-white text-lg font-bold shadow-md'
                }>
                <LazyImage
                  priority={true}
                  src={g.img_2}
